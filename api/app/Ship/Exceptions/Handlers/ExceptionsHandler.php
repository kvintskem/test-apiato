...
use App\Ship\Exceptions\ApiBaseException;
use App\Ship\Exceptions\ForbiddenException;
use App\Ship\Responses\JsonExceptionResponse;
use Exception;
...
class ExceptionsHandler extends CoreExceptionsHandler
{
  ...
  public function render($request, Exception $exception)
  {
    ...
    if ($exception instanceof ApiBaseException) {
      return JsonExceptionResponse::send($exception);
    }

    if ($exception instanceof \Spatie\Permission\Exceptions\UnauthorizedException) {
      return JsonExceptionResponse::send(new ForbiddenException());
    }
